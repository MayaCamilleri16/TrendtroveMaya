...
// Fetch spring pins from the database
...
<head>
    ...
    <title>Trendtrove - Spring Collection</title>
    <!-- Bootstrap CSS -->
...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="ml-auto">
        <h1 class="title">Spring Collection</h1>
    </div>
...
<main id="content">
    ...
    <h2 class="title" style="text-align: center; margin-top: 20px;">Spring Collection</h2>

    <!-- Container -->
    <div class="grid-container">
        <?php
        // Display fetched spring pins
        foreach ($pins as $pin) {
            echo "<div class='card'>
